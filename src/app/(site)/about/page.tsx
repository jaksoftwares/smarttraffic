import { Target, Brain, Globe, CheckCircle, Camera, BarChart4, Lightbulb, Heart, Rocket, MapPin, ArrowRight, Ambulance, CloudRain, Droplet, Clock, BarChart2, XCircle, Zap, Circle, AlertTriangle } from "lucide-react";
...
<section className="py-24 bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white relative overflow-hidden">
  <div className="absolute inset-0 opacity-20">
    <svg width="100%" height="100%">
      <pattern id="grid-pattern" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
        <path d="M 80 0 L 0 0 0 80" fill="none" stroke="rgba(59,130,246,0.1)" strokeWidth="1"/>
      </pattern>
  ...
  <div className="max-w-7xl mx-auto px-6 relative z-10">
    <div className="text-center mb-20">
      <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-red-400 via-orange-300 to-yellow-400 text-transparent bg-clip-text mb-6">
        Kenya&apos;s Traffic Crisis
      </h2>
      <StylishUnderline color="text-orange-400" position="top" />
    </div>

    <div className="grid md:grid-cols-2 gap-12 mb-24">
      {/* Problem Statistics */}
      <div className="space-y-8">
        <div className="bg-red-900/20 border border-red-400/30 rounded-2xl p-6">
          ...
          <ul className="space-y-4 text-gray-300">
            <li className="flex items-start">
              <Circle className="w-2 h-2 mt-2 mr-3 text-red-400 flex-shrink-0" />
              <span><strong>Nairobi loses KSh 50B yearly</strong> due to traffic congestion (4th worst in Africa)</span>
            </li>
            <li className="flex items-start">
              <Circle className="w-2 h-2 mt-2 mr-3 text-red-400 flex-shrink-0" />
              <span><strong>3+ hour</strong> daily commutes for 60% of residents</span>
            </li>
            <li className="flex items-start">
              <Circle className="w-2 h-2 mt-2 mr-3 text-red-400 flex-shrink-0" />
              <span><strong>40% longer</strong> emergency response times due to gridlock</span>
            </li>
            <li className="flex items-start">
              <Circle className="w-2 h-2 mt-2 mr-3 text-red-400 flex-shrink-0" />
              <span><strong>25% of fuel</strong> wasted idling in traffic daily</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center">
              ...
              <span className="text-sm">Static traffic lights</span>
            </div>
            <div className="flex items-center">
              <XCircle className="w-4 h-4 mr-2 text-red-400" />
              <span className="text-sm">No real-time adaptation</span>
            </div>
            <div className="flex items-center">
              <XCircle className="w-4 h-4 mr-2 text-red-400" />
            ...
            <div className="flex items-center">
              <XCircle className="w-4 h-4 mr-2 text-red-400" />
              <span className="text-sm">Matatu chaos</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 rounded-2xl p-1 h-full">
        <div className="bg-gray-950 rounded-xl h-full p-6 border border-orange-400/20">
          <h3 className="text-xl font-bold text-white mb-6 flex items-center">
            <BarChart2 className="w-6 h-6 mr-3 text-orange-400" />
            The Domino Effect
          </h3>
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <div>
                <h4 className="font-medium text-white">Time Loss</h4>
                <p className="text-sm text-gray-400">2.5M hours wasted daily</p>
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div>
                <h4 className="font-medium text-white">Fuel Waste</h4>
                <p className="text-sm text-gray-400">KSh 8B lost annually</p>
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div>
                <h4 className="font-medium text-white">Pollution</h4>
                <p className="text-sm text-gray-400">30% of Nairobi&apos;s emissions</p>
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div>
                <h4 className="font-medium text-white">Emergency Delays</h4>
                <p className="text-sm text-gray-400">15% higher mortality</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative group">
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-4 border border-white/10 group-hover:border-yellow-400/30 transition-all duration-500">
               ...
               <div className="relative rounded-2xl h-80 overflow-hidden shadow-md">
                <Image
                  src="/images/smart-city-vision.jpg" // You can replace this with your own optimized image
                  alt="Smart City Vision Illustration"
                  layout="fill"
                  objectFit="cover"
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 bg-black/40">
                  <Globe className="w-16 h-16 mb-4 animate-spin" style={{ animationDuration: '20s' }} />
                  <p className="text-xl font-semibold">Our Vision</p>
                  <p className="text-sm text-white/80">A future of smarter, safer, and sustainable urban mobility</p>
                </div>
              </div>
            ...
            <div className="relative group order-2 lg:order-1">
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-4 border border-white/10 group-hover:border-green-400/30 transition-all duration-500">
                <div className="relative overflow-hidden rounded-2xl">
                 <div className="relative rounded-2xl h-80 overflow-hidden shadow-md">
                  <Image
                    src="/images/ai-transport-neural-networks.jpg" 
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 bg-black/40">
                    ...
                    <p className="text-sm text-white/80">Harnessing AI to optimize urban mobility through neural intelligence</p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group">
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 group-hover:border-green-400/30 transition-all duration-500">
                <div className="relative overflow-hidden rounded-2xl">
                  <div className="relative rounded-2xl h-96 overflow-hidden shadow-md">
                  <Image
                    src="/images/future-smart-city.jpg"
                    alt="Future Smart City Transformation"
                    layout="fill"
                    objectFit="cover"
                    className="brightness-75"
                    priority
                  />
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 bg-black/40">
                    <MapPin className="w-20 h-20 mb-4 animate-bounce" />
                    <p className="text-2xl font-semibold">The Future City</p>
                    <p className="text-sm text-white/80">Envisioning data-driven, sustainable urban transformation</p>
                  </div>
                </div>
      ...
      {/* Team Section */}
      <section id="team" className="py-24 bg-gradient-to-b from-black via-gray-900 to-gray-950 -mt-16">
        <div className="max-w-7xl mx-auto px-6">
          <StylishUnderline color="text-purple-400" position="top" />
          <TeamSection/>
